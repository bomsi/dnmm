...
{
    /// <summary>
    /// Note that this class for the most part is a carbon copy of a sample 
    /// project that can be found at:
    /// https://github.com/FacticiusVir/SharpVk-Samples
    /// Its code is used as a learning tool. All credit for writing the program
    /// logic goes to its creator.
    /// </summary>
                ...
                Attachments = new[]
                       {
                        new AttachmentDescription
                        {
                            ...
                            InitialLayout = SharpVk.ImageLayout.Undefined,
                            FinalLayout = SharpVk.ImageLayout.PresentSource
                        },
                    },
                Subpasses = new[]
                       {
                        new SubpassDescription
                        {
                            ...
                            ColorAttachments = new []
                            {
                                ...
                                {
                                    Attachment = 0,
                                    Layout = SharpVk.ImageLayout.ColorAttachmentOptimal
                                }
                            }
                        }
                    },
